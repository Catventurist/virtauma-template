...
seo:
  description: Learn how to write your documentation with Virtauma and Nuxt Content.
  title: Edition
---

Virtauma lets you write all your content in **Markdown** but also provide the ability to integrate **components** with the [MDC syntax](https://content.nuxt.com/docs/files/markdown#mdc-syntax) provided by **Nuxt Content**.
...
::tip{to="/en/essentials/components"}
...
To get started, simply edit or add a `.md` files in the [`content/`](https://content.nuxt.com/usage/content-directory) directory to have your pages updated. Virtauma will handle routing, navigation, and full-text search automatically.
...
| `layout`      | `string`                                 | Change Nuxt layout of the page (default to `docs` defined by Virtauma).                                                          |   |
