...
description: Customize your Virtauma documentation from the Nuxt application configuration file.
seo:
  description: Customize your Virtauma documentation from Nuxt application configuration file.
---

Virtauma allows you to configure your documentation through the [app.config.ts](https://nuxt.com/docs/guide/directory-structure/app-config) file provided by Nuxt.
...
Technical SEO is tricky and boring. Virtauma offers a solid, opt-in default setup that works out of the box, while giving you full control to customize your SEO metadata, from page titles to social sharing images.

### Metadata

Virtauma offers flexible `SEO` metadata configuration, allowing you to easily override values globally or on a per-page basis.
...
- Built-in Virtauma interface strings
...
Virtauma reads your `.git/` folder to get the `url` and `branch` of your repository to add:
