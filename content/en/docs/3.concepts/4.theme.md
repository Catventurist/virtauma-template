...
title: Theme
description: Custom the appearance of your Virtauma documentation thanks to Nuxt UI
  flexible theming.
---

Virtauma is built on top of Nuxt UI and takes full advantage of Tailwind CSS v4, CSS variables. The Tailwind Variants API offers a flexible and scalable theming system.
...
Virtauma uses pre-configured color aliases that are used to style components and power the `color` props across the UI.
