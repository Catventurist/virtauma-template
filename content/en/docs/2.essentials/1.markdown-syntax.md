...
Virtauma supports most Markdown formatting options.
...
For linking within your documentation, use root-relative paths like `/en/docs/getting-started/installation`.
...
class: "[&>div]:*:my-0"
---
> Virtauma is a collection of Vue components, composables and utils designed to create beautiful and accessible user interfaces.
