---
title: Color Mode
description: 'Virtauma integrates with Nuxt Color Mode to allow for easy switching between light and dark themes.'
links:
...
Virtauma automatically registers the [`@nuxtjs/color-mode`](https://github.com/nuxt-modules/color-mode) module for you, so there's no additional setup required.
