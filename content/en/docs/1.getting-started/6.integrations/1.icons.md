---
title: Icons
description: 'Virtauma integrates with Nuxt Icon to access over 200,000+ icons from Iconify.'
links:
  - label: 'Iconify'
...
Virtauma automatically registers the [`@nuxt/icon`](https://github.com/nuxt/icon) module for you, so there's no additional setup required.
...
Some components also have an `icon` prop to display an icon, like the [Button](https://ui.nuxt.com/docs/components/button).
