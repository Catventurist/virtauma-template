---
title: Content
description: 'Virtauma integrates with Nuxt Content to deliver beautiful typography and consistent component styling.'
...
Virtauma provides its own custom implementations of all prose components for seamless integration with `@nuxt/content`. This approach ensures consistent styling, complete control over typography, and perfect alignment with the Virtauma design system so your content always looks and feels cohesive out of the box.
