...
description: Learn how to customize Virtauma components with the Tailwind Variants API for advanced, flexible, and maintainable styling.
...
Virtauma components are styled using the [Tailwind Variants](https://www.tailwind-variants.org/) API, which provides a powerful way to create variants and manage component styles.
...
::tip{to="https://ui.nuxt.com/docs/getting-started/installation/#themedefaultvariants"}
...
You have multiple ways to customize the appearance of Virtauma components, you can do it for all components at once or on a per-component basis.
