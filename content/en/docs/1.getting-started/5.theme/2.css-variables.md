---
title: CSS Variables
description: Virtauma uses CSS variables as design tokens for flexible, consistent theming with built-in light and dark mode support.
navigation.icon: 'i-lucide-swatch-book'
---

## Colors

Virtauma provides Tailwind CSS utility classes for each [semantic color](/en/docs/getting-started/theme/design-system#semantic-colors) you define, allowing you to use class names like `text-error` or `bg-success`:
...
::warning
You can't use `primary: 'black'` in your [**config**](/en/docs/getting-started/theme/design-system#runtime-configuration) because `black` doesn't have multiple shades. To use solid black or white as your primary color, set it directly in your `main.css` file:
...
Virtauma provides Tailwind CSS utility classes for text colors, allowing you to use class names like `text-dimmed` or `text-muted`:
...
Virtauma provides Tailwind CSS utility classes for background colors, allowing you to use class names like `bg-default` or `bg-muted`:
...
Virtauma provides Tailwind CSS utility classes for border colors, allowing you to use class names like `border-default` or `border-muted`:
...
Virtauma overrides Tailwind CSS's default `rounded-*` utilities with a unified border radius system, allowing you to use regular [border radius utilities](https://tailwindcss.com/docs/border-radius) like `rounded-xs` or `rounded-2xl`:
...
Virtauma provides a `--ui-container` CSS variable that controls the maximum width of the [Container]() component.
...
Virtauma provides a `--ui-header-height` CSS variable that controls the height of the [Header](https://ui.nuxt.com/docs/components/header) component.
...
Virtauma applies default classes on the `<body>`{lang="html"} element of your app for consistent theming across light and dark modes:
